    ...
    <div className="w-full relative bg-slate-50/50">
      ...
      <section className="relative pt-40 pb-20 min-h-screen">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <h1 className="text-5xl font-display font-bold text-slate-900 mb-6">Testimonials</h1>
          <p className="text-lg text-slate-600">See what our travelers are saying.</p>
        </div>
      </section>
