  ...
  <div className="destination-card group relative overflow-hidden rounded-[2.5rem] bg-white shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 hover-lift w-full border border-slate-100">
    ...
    <div className="p-6">
      <div className="flex justify-between items-start mb-2">
        ...
        <div className="bg-gradient-to-br from-sky-500 to-purple-600 px-3 py-1.5 rounded-xl text-white font-bold text-sm shrink-0 ml-2 shadow-lg">
          ${price}
        </div>
      </div>
    </div>
          ...
          <div className="relative z-10 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <button
                ...
                className="hero-btn w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-sky-600 to-purple-600 text-white rounded-2xl font-bold hover:shadow-2xl hover:scale-105 active:scale-95 transition-all shadow-xl flex items-center justify-center gap-2 group animate-pulse-glow"
              >
