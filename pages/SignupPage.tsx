        ...
        <div className="w-full md:w-[50%] p-8 sm:p-12 lg:p-20 flex flex-col justify-center bg-white relative">
            ...
            <div className="max-w-md mx-auto w-full">
                <div className="mb-10 text-center md:text-left">
                    ...
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl font-display font-extrabold text-slate-900 mb-3">
                        {SIGNUP_STEPS[step-1].title}
                    </h1>
                    <p className="text-slate-500 font-medium text-sm md:text-base leading-relaxed">
                        {SIGNUP_STEPS[step-1].desc}
                    </p>
                </div>
                ...
                <div className="step-content space-y-6">
                        ...
                        <div className="space-y-5 animate-in fade-in slide-in-from-right-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                {['Cultural', 'Heritage', 'Extreme', 'Leisure'].map(lvl => (
                                    <button key={lvl} className="p-5 rounded-2xl border-2 border-slate-100 text-sm font-bold text-slate-600 hover:border-sky-500 hover:text-sky-600 hover:bg-sky-50 transition-all text-center flex flex-col items-center gap-2 group">
                                        <Sparkles size={16} className="text-slate-300 group-hover:text-sky-500" />
                                        {lvl}
                                    </button>
                                ))}
                            </div>
                    ...
                    {step === 3 && (
                        <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                            ...
                            <InputField label="Password" type="password" placeholder="••••••••" icon={<ShieldCheck size={18} />} />
                        </div>
                    )}
